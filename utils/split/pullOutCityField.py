...
def pull_out_city_field(
    non_prefecture_address_data_array: list[str], splittedAddressDataDictionaries) -> list[str]:
    """
    args: non_prefecture_address_data_array: list[str], splittedAddressDataDictionaries
