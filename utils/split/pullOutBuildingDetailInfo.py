...
def pull_out_buildingdetailinfo(AddressDataForFormatting, manipulated_others_tail: list[str]):
    """
    args:  AddressDataForFormatting, manipulated_others_tail: list[str]
    return: void
    """
    AddressDataForFormatting.building_detail_info = utils.extract.detail.building_detail.extract_building_detail(
